local ABOUT = {
  ...
  -- 
  local function archiveSpec (spec)
  ...
  local function info (path)   -- this is, in fact, __readHeader for the outside world
  ...
  local function create (path,archiveList,xFilesFactor,aggregationMethod)
    -- path is a string
  ...
  local function update (path,value,timestamp, now)
    --path is a string
    --value is a float
  ...
  local function setAggregationMethod (path, aggregationMethod, xFilesFactor)  
    -- path is a string
...
return {
  ...
  setAggregationMethod    = setAggregationMethod;     -- change data aggregation method for archives in a file
  
  __file_open = __file_open,      -- allow low-level access to files
